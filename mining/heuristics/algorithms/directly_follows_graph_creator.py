...
from mining.heuristics.datastructure.case_id_dictionary import CaseIdDictionary
from mining.heuristics.datastructure.lossy_counting_dictionary import LossyCountingDictionary
